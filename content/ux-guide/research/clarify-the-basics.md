...
Foundational research is the research you do to identify and clarify the team’s objectives, assumptions, and constraints. On the 18F Methods site, [discover methods](https://18f-guides.netlify.app/methods/discover/) help to build context for the problem you’re investigating. This includes; [stakeholder and user interviews](https://18f-guides.netlify.app/methods/discover/stakeholder-and-user-interviews/), [heuristic evaluation](https://18f-guides.netlify.app/methods/discover/heuristic-evaluation/), and [hopes and fears workshops](https://18f-guides.netlify.app/methods/discover/hopes-and-fears/). Foundational research is primarily (though not exclusively) the domain of [18F Strategy Development ](https://18f.gsa.gov/work-with-us/) engagements and results in, among other things, a [problem statement as outlined on our GitHub repository](https://github.com/18F/path-analysis/blob/master/approach.md#2-draft-a-problem-statement).

Foundational research helps you ask: what problem are we trying to solve?

### Descriptive research

Descriptive research focuses on understanding, validating, and documenting the context of an assumed problem. On the 18F Methods site, [decide methods](https://18f-guides.netlify.app/methods/#decide) help develop a deeper understanding of workflows and processes. It could look like describing the needs and characteristics of a particular audience like [journey mapping or Mental modeling](https://18f-guides.netlify.app/methods/decide/journey-mapping/).

Descriptive research helps you ask: who or what are we solving this problem for? 

### Generative research

Generative research helps you better frame the problem(s) you’re solving, spark new ideas, and reveal opportunities. On the 18F Methods site, [make methods](https://18f-guides.netlify.app/methods/#make) help create testable designs like [prototyping and Wireframing](https://18f-guides.netlify.app/methods/make/wireframing/) to ensure your product reflects your users’ needs. 
...
Evaluative research is the research you do to test assumptions, hypotheses, and the ease of use of design solutions. On the 18F Methods site, [validate methods](https://18f-guides.netlify.app/methods/#validate) like [multivariate testing](https://18f-guides.netlify.app/methods/validate/multivariate-testing/), and [usability testing ](https://18f-guides.netlify.app/methods/validate/usability-testing/) help to understand how to determine if the product or service delivers as you designed.
...
With most projects you’ll conduct an in-person kickoff, during which you may have the chance to meet, interview, and conduct activities with stakeholders. If feasible, consider adding [contextual inquiry as described in the 18F methods](https://18f-guides.netlify.app/methods/discover/contextual-inquiry/) into your kick-off activities. Direct observation will provide firsthand understanding of your stakeholders’ and users’ processes and contexts.
