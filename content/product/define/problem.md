...
- [How to prioritize problem statements (1)](https://18f-guides.netlify.app/methods/discover/kj-method/): KJ Method, a general prioritization method involving brainstorming, [affinity grouping](https://18f-guides.netlify.app/methods/decide/affinity-mapping/), and ranking (e.g., [dot voting](https://18f-guides.netlify.app/methods/discover/dot-voting/)).
...
- [How to identify the root cause of a problem](https://18f-guides.netlify.app/methods/discover/five-whys/): Five Whys, an iterative process for uncovering the root cause underlying the observable problem.
